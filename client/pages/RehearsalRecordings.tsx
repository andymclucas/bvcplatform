...
export default function RehearsalRecordings() {
  const { user } = useAuth();
        ...
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              {isAdmin
                ? "Manage and upload rehearsal recordings for your members."
                : "Access recordings from rehearsals you attended."}
            </p>
          </div>
          {isAdmin && (
              ...
              {isAdmin ? (
                <>
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Upload your first rehearsal recording to get started.
                  </p>
                ...
                <>
                  ...
                  <p className="font-medium text-foreground mb-1">No recordings available</p>
                  <p className="text-sm text-muted-foreground">
                    Recordings are only available to members who attended that rehearsal.
                    Attend a rehearsal to unlock access to its recording.
                  </p>
                </>
              )}
            </CardContent>
      ...
      <AlertDialog open={deleteId !== null} onOpenChange={(v) => !v && setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the recording. Members who attended this rehearsal will
              lose access to it. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
